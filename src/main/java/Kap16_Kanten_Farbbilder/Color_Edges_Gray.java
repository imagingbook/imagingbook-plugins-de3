...
import imagingbook.pub.color.edge.GrayscaleEdgeDetector;
import imagingbook.pub.color.edge.GrayscaleEdgeDetector.Parameters;
...
public class Color_Edges_Gray implements PlugInFilter {
    ...
    public void run(ImageProcessor ip) {
    	...
    	imagingbook.pub.color.edge.GrayscaleEdgeDetector.Parameters params = new Parameters();
